  ...
  private otpEmailHtml(code: string): string {
    return `
      <div style="font-family:-apple-system,BlinkMacSystemFont,Segoe UI,Roboto,Arial,sans-serif;line-height:1.5;color:#e6edf6;">
        <h2 style="margin:0 0 12px;font-size:28px;line-height:1.2;color:#f8fbff;">Verify your TomaFix owner account</h2>
        <p style="margin:0 0 14px;color:#d7e2ee;">Use this code to verify your email:</p>
